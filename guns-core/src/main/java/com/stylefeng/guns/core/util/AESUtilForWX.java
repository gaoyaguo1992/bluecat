...
public class AESUtilForWX {
     ...
     * @throws Exception 
     */  
    public static String encryptDataForWxRefund(String data,String wxKey) throws Exception {  
        // 创建密码器  
        Cipher cipher = Cipher.getInstance(ALGORITHM_MODE_PADDING);  
        // 初始化  
        SecretKeySpec key = new SecretKeySpec(MD5Helper.MD5Encode(wxKey).toLowerCase().getBytes(), ALGORITHM);  
     ...
     * @throws Exception 
     */  
    public static String decryptDataForWxRefund(String base64Data,String wxKey) throws Exception {  
        Cipher cipher = Cipher.getInstance(ALGORITHM_MODE_PADDING);          
        SecretKeySpec key = new SecretKeySpec(MD5Helper.MD5Encode(wxKey).toLowerCase().getBytes(), ALGORITHM);  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        String B = AESUtilForWX.decryptDataForWxRefund(req_info,"kkkk");  
        ...
        String str = "<root>"+
                ...
                "</root>";
        System.out.println(decryptDataForWxRefund(str,"kkk"));
    }
}