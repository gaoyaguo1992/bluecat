...
@MapperScan(basePackages = {"com.stylefeng.guns.modular.*.dao","com.stylefeng.guns.sharecore.*.dao"
		, "com.stylefeng.guns.sharecore.common.persistence.dao","com.stylefeng.guns.sharecore.modular.system.dao"})
