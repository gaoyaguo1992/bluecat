...
function getTotalDeviceBusinessData() {
	var ajax = new $ax(Feng.ctxPath + "/index/totalDeviceBusinessData", function (data) {
		var totalAmountCompareByDay = data.resultBO.totalAmountCompareByDay == null ? '0%':Number(data.resultBO.totalAmountCompareByDay*100).toFixed(2)+"%";
		var finishOrdersCompareByDay = data.resultBO.finishOrdersCompareByDay == null ? '0%':Number(data.resultBO.finishOrdersCompareByDay*100).toFixed(2)+"%";
		var ordersCompareByDay = data.resultBO.ordersCompareByDay == null ? '0%':Number(data.resultBO.ordersCompareByDay*100).toFixed(2)+"%";
