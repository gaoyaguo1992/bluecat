...
MerchantInfoInfoDlg.validateData = function() {
    $('#merchantInfoFrom').data("bootstrapValidator").resetForm();
    $('#merchantInfoFrom').bootstrapValidator('validate');
    return $("#merchantInfoFrom").data('bootstrapValidator').isValid();
}
/**
 * 提交添加
 */
...
$(function() {
 Feng.initValidator("merchantInfoFrom", MerchantInfoInfoDlg.validateFields);
