...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    @Override
    public List<ZTreeNode> menuTreeListByRoleIds(List<Integer> roleIds) {
        return this.baseMapper.menuTreeListByRoleIds(roleIds);
    }

    @Override
    public List<ZTreeNode> menuTreeListByMenuIdsByRoleIds(List<Long> menuIds,List<Integer> roleIds) {
        return this.baseMapper.menuTreeListByMenuIds(menuIds);
    }
