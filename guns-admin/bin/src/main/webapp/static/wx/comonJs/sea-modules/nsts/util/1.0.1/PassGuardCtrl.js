define("nsts/util/1.0.1/PassGuardCtrl", ["jquery-debug"], function(require,
        exports, module) {
    ...
    var PGEdit_MacOs = "PassGuardXNew.pkg";
    var PGEdit_MacOs_VERSION = "1.0.0.1";

    var PGEdit_MacOs_Safari = "PassGuardXNew.pkg";
            ...
            prototype: {
                ...
                getpgeHtml: function() {
                    ...
                    if (this.osBrowser == 1 || this.osBrowser == 3) {
                        ...
                        if (this.settings.pgeOnkeydown != undefined && this.settings.pgeOnkeydown != "")
                            pgeOcx += ' input_1013="' + this.settings.pgeOnkeydown + '"';

                        if (this.settings.tabCallback != undefined && this.settings.tabCallback != "")
                            pgeOcx += ' input_1009="document.getElementById(\'' + this.settings.tabCallback + '\').focus()"';

                        if (this.settings.pgeFontName != undefined && this.settings.pgeFontName != "")
                            pgeOcx += ' FontName="' + this.settings.pgeFontName + '"';

                        if (this.settings.pgeFontSize != undefined && this.settings.pgeFontSize != "")
                            pgeOcx += ' FontSize=' + Number(this.settings.pgeFontSize) + '';
                ...
                setColor: function() {
                    ...
                    if (!this.checkInstall()) {
                        ...
                        try {
                            var control = document.getElementById(this.settings.pgeId);
                            if (this.settings.pgeBackColor != undefined && this.settings.pgeBackColor != "")
                                control.BackColor = this.settings.pgeBackColor;
                            if (this.settings.pgeForeColor != undefined && this.settings.pgeForeColor != "")
