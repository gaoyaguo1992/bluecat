define(["jquery-debug"], function(require, exports, module) {
    ...
    /*SuperSlide图片切换*/
    $("div.focusBox").slide({mainCell: ".pic", effect: "fold", autoPlay: true, delayTime: 600, trigger: "click"});
    $("#g-list").slide({delayTime:0,trigger:"click"});
    jQuery("#chart").slide({delayTime:0,trigger:"click"});
    jQuery("#data").slide({effect:"leftLoop"});
    jQuery("#com").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"leftLoop",autoPlay:true,vis:5,interTime:4000});
    jQuery("#daily-news").slide({delayTime:0,trigger:"click"});
});