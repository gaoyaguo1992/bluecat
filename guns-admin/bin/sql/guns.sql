...
-- 用户表增加商户类型，用于做代理商登陆后台查看到敏感数据问题
alter table sys_user add column merchant_type tinyint(4) default -1 comment "商户类型（-1不指定商户类型，11顶级代理，12一级代理，13二级代理，14铺货商）";



-- 删除不相关表
DROP TABLE IF EXISTS `active_charger_host_round_info`;

DROP TABLE IF EXISTS `active_charger_host_rule`;

DROP TABLE IF EXISTS `active_charger_host_rule_detail_info`;

DROP TABLE IF EXISTS `active_round_detail_rule`;

DROP TABLE IF EXISTS `agents_total_info`;

DROP TABLE IF EXISTS `card_info`;

DROP TABLE IF EXISTS `charger_master_trade_info`;

DROP TABLE IF EXISTS `complain`;

DROP TABLE IF EXISTS `coupons`;

DROP TABLE IF EXISTS `coupons_cancel_out_info`;

DROP TABLE IF EXISTS `coupons_draw_info`;

DROP TABLE IF EXISTS `coupons_issue_info`;

DROP TABLE IF EXISTS `cust_form_id`;

DROP TABLE IF EXISTS `cust_scan_info`;

DROP TABLE IF EXISTS `cust_share_code`;

DROP TABLE IF EXISTS `danti_return_apply_record`;

DROP TABLE IF EXISTS `device_ad_info`;

DROP TABLE IF EXISTS `device_error`;

DROP TABLE IF EXISTS `device_guarantee_trade_info`;

DROP TABLE IF EXISTS `device_product_ratio`;

DROP TABLE IF EXISTS `device_use_ratio_day`;

DROP TABLE IF EXISTS `device_white_list`;

DROP TABLE IF EXISTS `device_zone_info`;

DROP TABLE IF EXISTS `discount_coupons`;

DROP TABLE IF EXISTS `distribute_biz_config`;
...
DROP TABLE IF EXISTS `full_cut_coupons`;

DROP TABLE IF EXISTS `gift_info`;

DROP TABLE IF EXISTS `goods`;

DROP TABLE IF EXISTS `manual_trade_handle_info`;

DROP TABLE IF EXISTS `marketing_item`;
...
DROP TABLE IF EXISTS `mer_charger_not_used_some_days`;

DROP TABLE IF EXISTS `mer_dev_not_used_seven_days`;

DROP TABLE IF EXISTS `merchant_ad_access_info`;

DROP TABLE IF EXISTS `merchant_ad_click`;

DROP TABLE IF EXISTS `merchant_ad_info`;

DROP TABLE IF EXISTS `mq_msg`;

DROP TABLE IF EXISTS `order_chuzu_info`;

DROP TABLE IF EXISTS `order_trade_info`;

DROP TABLE IF EXISTS `order_zujie_info`;

DROP TABLE IF EXISTS `permission`;

DROP TABLE IF EXISTS `recon_runing_record`;

DROP TABLE IF EXISTS `report_template_info`;

DROP TABLE IF EXISTS `reward_withdraw_apply_record`;

DROP TABLE IF EXISTS `right_info`;

DROP TABLE IF EXISTS `right_metadata`;

DROP TABLE IF EXISTS `salesman_day_statistics`;

DROP TABLE IF EXISTS `salesman_info`;

DROP TABLE IF EXISTS `sha_capital_change_record`;

DROP TABLE IF EXISTS `sha_trade_info`;

DROP TABLE IF EXISTS `terminal_defend_apply_record`;

DROP TABLE IF EXISTS `terminal_imgs_info`;

DROP TABLE IF EXISTS `traning_file_upload_info`;
...
DROP TABLE IF EXISTS `user_merchant_ref_info`;
...
DROP TABLE IF EXISTS `zone_model_info`;

DROP TABLE IF EXISTS `tbl_content_template`;

DROP TABLE IF EXISTS `tbl_product_template_rel`;

DROP TABLE IF EXISTS `tbl_short_message_info`;
...
DROP TABLE IF EXISTS `merchant_comment_options_config`;

DROP TABLE IF EXISTS `merchant_contract_history`;

DROP TABLE IF EXISTS `merchant_device_modify_record`;

DROP TABLE IF EXISTS `merchant_evaluation_info`;

DROP TABLE IF EXISTS `auto_wx_respone_msg`;

DROP TABLE IF EXISTS `shopkeeper_month_plan`;

DROP TABLE IF EXISTS `system_upgrade_info`;

DROP TABLE IF EXISTS `dev_trade_gather_info`;

ALTER TABLE `trade_info` RENAME TO `withdraw_order_info`;

ALTER TABLE `withdraw_order_info` change `zudian_id` `zd_id` bigint(20);
