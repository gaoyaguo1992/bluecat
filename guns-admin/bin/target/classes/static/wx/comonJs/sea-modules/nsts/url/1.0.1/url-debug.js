define("nsts/url/1.0.1/url-debug", [ "jquery-debug" ], function(require,
		exports, module) {
		...
		jQuery.url = function() {
			...
			var options = {
				...
				key : [ "source", "protocol", "authority", "userInfo", "user",
						...
						"directory", "file", "query", "anchor" ], // keys available to query
			...
			var getSegments = function() {
				...
				segments = parsed.path.length == 1 ? {} : (p
						.charAt(p.length - 1) == "/" ? p.substring(1,
						p.length - 1) : path = p.substring(1)).split("/");
			};
