...
MerchantInfo.initColumn = function () {
    return [
        ...
        {title: '商户类型', field: 'merchantType', visible: true, width: '120px', align: 'center', valign: 'middle'},
        ...
        {title: '商户行业类型', field: 'industryCategoryCode', visible: true, width: '150px', align: 'center', valign: 'middle'},
