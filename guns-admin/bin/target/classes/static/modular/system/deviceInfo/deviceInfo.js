...
DeviceInfo.initColumn = function () {
    return [
            ...
            {title: '设备类型Id', field: 'deviceTypeId' , width: '90px', visible: true, align: 'center', valign: 'middle'},
            ...
            {title: '设备状态名称', field: 'deviceStatusCN',width: '120px', visible: true, align: 'center', valign: 'middle'},
            {title: '激活时间', field: 'onlineDatetime', visible: true,width: '120px', align: 'center', valign: 'middle'},
            {title: '激活商户id', field: 'onlineMerchantId', visible: true, width: '120px',align: 'center', valign: 'middle'},
            {title: '激活商户名称', field: 'onlineMerchantCn', visible: true, width: '180px',align: 'center', valign: 'middle'},
