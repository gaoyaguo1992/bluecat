...
(function () {
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    pagination: this.pagination,     	 //是否显示分页（*） 是否显示分页条
	    ...
	    setOnPostBody: function (onPostBodyFun) {
	       this.onPostBody=onPostBodyFun;
	    },
        /**
         * 设置高度
         * @param height
         ...
         * @param bol
         */
        setShowColumns:function(bol){
        	this.showColumns=bol;
        },
        /**
         * 是否显示刷新按钮
         * @param bol
         */
        setShowRefresh:function(bol){
        	this.showRefresh=bol;
        },
        /**
         * 向后台传递的自定义参数
         * @param param
