 ...
 * 
 */
public class ExgrainSysUncheckedException extends ExgrainUncheckedException {
	 ...
	 */
	public ExgrainSysUncheckedException(String code, String sysMessage, String userMessage) {
		super(sysMessage);
	 ...
	 */
	public ExgrainSysUncheckedException(String code, String sysMessage, String userMessage, Throwable cause) {
