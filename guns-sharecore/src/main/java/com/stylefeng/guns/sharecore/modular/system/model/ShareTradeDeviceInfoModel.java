...
public class ShareTradeDeviceInfoModel {
    ...
    private BigDecimal fee3HourAount;
    ...
    private BigDecimal tradeYfjAmount;

    private Long tradeCustNo;
    ...
    private Integer tradeFeeTypeId;
    ...
    public BigDecimal getFee3HourAount() {
        return fee3HourAount;
    }

    public void setFee3HourAount(BigDecimal fee3HourAount) {
        this.fee3HourAount = fee3HourAount;
    }
    ...
    public BigDecimal getTradeYfjAmount() {
        return tradeYfjAmount;
    }

    public void setTradeYfjAmount(BigDecimal tradeYfjAmount) {
        this.tradeYfjAmount = tradeYfjAmount;
    }

    public Long getTradeCustNo() {
        return tradeCustNo;
    }

    public void setTradeCustNo(Long tradeCustNo) {
        this.tradeCustNo = tradeCustNo;
    }
    ...
    public Integer getTradeFeeTypeId() {
        return tradeFeeTypeId;
    }

    public void setTradeFeeTypeId(Integer tradeFeeTypeId) {
        this.tradeFeeTypeId = tradeFeeTypeId;
    }
